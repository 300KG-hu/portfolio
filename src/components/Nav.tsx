  ...
  return (
    ...
    >
      <div className="h-full flex justify-between items-center mx-6">
        <code className="md:text-2xl text-xl font-bold bg-gradient-to-r from-purple-500 to-blue-500 inline-block text-transparent bg-clip-text">{`<Husam Sultana />`}</code>
