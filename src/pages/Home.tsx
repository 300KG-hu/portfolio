      ...
      <div className="flex flex-col lg:flex-row-reverse lg:justify-between justify-start items-center lg:my-32">
        ...
        >
          <img
            src={ProfileImage}
            alt="ProfileImage"
            className="rounded-full border-4 border-black dark:border-dark-four mt-5 blob w-[250px] h-[300px] lg:w-[250px] lg:h-[300px]"
          />
        </motion.div>
        <motion.div
          viewport={{ once: true }}
        ...
        >
          ...
          <div className="flex flex-col lg:items-start lg:text-xl justify-center items-center dark:text-dark-four">
            <p>Greetings, I'm Husam Sultana</p>
            <p>Passionate Informatics Engineer</p>
            <p>I Thrive on Crafting Solutions Through Code 💻</p>
          </div>
          <div className="w-full flex lg:justify-start lg:mt-4 justify-center items-center mb-4">
            ...
            <a
              href="https://github.com/300KG-hu"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              href="https://www.linkedin.com/in/husam-sultana/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
