  ...
  return (
    ...
    >
      ...
      >
        ...
        Random Developer Coding Dreams into Reality and Building a Better Tomorrow 💻.
        </h2>
        <p className="text-justify text-sm md:text-lg mx-8 my-4 max-w-96 text-white font-light">
          I'm a quick learner and a passionate junior front-end web developer. I
          love solving coding challenges and staying updated on the latest tech
